...
import { Heart, FileText, DollarSign, Clock, CheckCircle, Plus, LogOut, Bell, Settings } from "lucide-react"
...
export default function PatientDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white flex">
      {/* Sidebar */}
      <div className="bg-gray-950 border-r border-gray-800 w-64 p-4 space-y-4">
      ...
      <div className="flex-1">
          ...
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-300">{user?.name || "Patient"}</span>
              </div>
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Welcome back, {user?.name?.split(" ")[0] || "Patient"}</h1>
            <p className="text-gray-400">Manage your medical funding applications and track your progress</p>
          </motion.div>
          {/* Application Modal */}
          ...
          >
            ...
            <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-sm">Donations Received</p>
                    <p className="text-2xl font-bold text-white">${stats.donationsReceived.toLocaleString()}</p>
                  </div>
            ...
            <Tabs defaultValue="applications" className="space-y-6">
              ...
              <TabsContent value="applications" className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black hover:from-yellow-500 hover:to-yellow-700" onClick={() => setShowApplyModal(true)}>
                      ...
                      <Card key={application._id} className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700">
                        <CardContent className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              <h3 className="text-lg font-semibold text-white mb-2">{application.title}</h3>
                              <div className="flex items-center space-x-4">
                            ...
                            <div className="text-right">
                              <p className="text-2xl font-bold text-yellow-400">${application.amount.toLocaleString()}</p>
