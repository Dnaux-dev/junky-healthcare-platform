    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 text-gray-900">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <Badge className="bg-yellow-500/20 text-yellow-600 border-yellow-500/30">Donor Dashboard</Badge>
              </div>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">{user?.name || "Donor"}</span>
              </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Welcome back, {user?.name?.split(" ")[0] || "Donor"}</h1>
          <p className="text-gray-600 text-sm sm:text-base">Continue making a difference in patients' lives through your generous support</p>
        </motion.div>
